  ...
  factions   = {
    ...
    -- ----------------------------------------------------------------
    {
      ...
      quests   = {
        ...
        { name="Acces : En avant toutes, Amiral ! - si pas encore fait",
          npc="Verifier votre status Voile sanglante", coords="Baie-du-Butin",
          zone="Tanaris",
          rep=0, type="onetime", questID=nil, mapID=nil,
          tip="Si vous avez deja monte la Voile sanglante a Honore precedemment, assurez-vous d'avoir complete la quete En avant toutes, Amiral ! avant de continuer Ravenholdt." },
      },
    },
    -- ----------------------------------------------------------------
    ...
    -- ----------------------------------------------------------------
    {
      ...
      quests   = {
        ...
        { name="Quetes de Gantrepression (Repetable)",
          npc="PNJ de Gantrepression", coords="Tanaris",
          zone="Tanaris",
          rep=350, type="daily", questID=nil, mapID=440,
          tip="Les quetes repetables de Gantrepression dans le desert de Tanaris donnent de la rep a Baie-du-Butin et aux autres factions Cartel." },
      },
    },
    -- ----------------------------------------------------------------
    ...
    -- ----------------------------------------------------------------
    {
      ...
      quests   = {
        ...
        { name="Demande de Coffrets (Repetable - voleur)",
          npc="Lou Pierret / Manoir Ravenholdt", coords="Mille Pointes",
          zone="Mille Pointes",
          rep=150, type="daily", questID=nil, mapID=400,
          tip="Quete repetable : remettez des Coffrets lourds a Lou Pierret dans le Manoir de Ravenholdt (Mille Pointes) pour 150 rep Long-Guet + Ravenholdt." },
      },
    },
    -- ----------------------------------------------------------------
