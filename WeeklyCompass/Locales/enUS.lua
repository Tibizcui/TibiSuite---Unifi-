...
ns:AddLocale("enUS", {
    ...
    TOTAL_WARBAND_UNKNOWN = "Warband bank: open it once with a character that has access to it",
    ...
    -- Fiche detaillee
    ACTIVITY_SHEET        = "Detailed sheet",
    TIP_LEFT_CLICK        = "Left click: detailed sheet",
    SHEET_ROTATE          = "Drag: rotate the model",
    SHEET_PREV            = "Previous character",
    SHEET_NEXT            = "Next character",
    SHEET_TIP_ENCHANT     = "Missing enchantment",
    SHEET_TIP_SOCKET      = "%d empty socket(s)",
    SHEET_LEVEL           = "Level %s",
    SHEET_UPDATED         = "Sheet from %s",
    SHEET_ILVL_LABEL      = "Equipped item level",
    SHEET_EQUIPMENT       = "Equipment",
    SHEET_WARN_ENCHANT    = "No enchant",
    SHEET_WARN_SOCKET     = "Empty socket",
    SHEET_SET             = "Raid set",
    SHEET_NO_SET          = "No raid set equipped",
    SHEET_SET_CURRENT     = "Current season",
    SHEET_SET_PREVIOUS    = "Previous season (%s)",
    SHEET_BONUS           = "%d pieces",
    SHEET_STATS           = "Secondary stats",
    STAT_CRIT             = "Critical strike",
    STAT_HASTE            = "Haste",
    STAT_MASTERY          = "Mastery",
    STAT_VERSA            = "Versatility",
    SHEET_VAULT           = "Great Vault",
    SHEET_RAIDS           = "Raid lockouts",
