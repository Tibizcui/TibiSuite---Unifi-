...
ns:AddLocale("frFR", {
    ...
    TRACK_NAME_MYTH       = "Mythe",       -- trackString FR reel : "Mythe 4/6" (sonde 0.5)
    ...
    TOTAL_WARBAND_UNKNOWN = "Banque de Bataillon : ouvre-la une fois avec un personnage qui y a accès",
    ...
    -- Fiche detaillee
    ACTIVITY_SHEET        = "Fiche détaillée",
    TIP_LEFT_CLICK        = "Clic gauche : fiche détaillée",
    SHEET_ROTATE          = "Glisser : tourner le modèle",
    SHEET_PREV            = "Personnage précédent",
    SHEET_NEXT            = "Personnage suivant",
    SHEET_TIP_ENCHANT     = "Enchantement manquant",
    SHEET_TIP_SOCKET      = "%d châsse(s) vide(s)",
    SHEET_LEVEL           = "Niveau %s",
    SHEET_UPDATED         = "Fiche du %s",
    SHEET_ILVL_LABEL      = "Niveau d'objet équipé",
    SHEET_EQUIPMENT       = "Équipement",
    SHEET_WARN_ENCHANT    = "Sans enchant.",
    SHEET_WARN_SOCKET     = "Châsse vide",
    SHEET_SET             = "Ensemble de raid",
    SHEET_NO_SET          = "Aucun ensemble de raid porté",
    SHEET_SET_CURRENT     = "Saison en cours",
    SHEET_SET_PREVIOUS    = "Saison précédente (%s)",
    SHEET_BONUS           = "%d pièces",
    SHEET_STATS           = "Statistiques secondaires",
    STAT_CRIT             = "Coup critique",
    STAT_HASTE            = "Hâte",
    STAT_MASTERY          = "Maîtrise",
    STAT_VERSA            = "Polyvalence",
    SHEET_VAULT           = "Grand Coffre",
    SHEET_RAIDS           = "Verrouillages de raid",
