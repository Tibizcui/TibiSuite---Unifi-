-- COPIE de Stats/Libs/LZW.lua, utilisee par Opacity pour ses codes de profil
-- (export / import). Les codes Opacity ne sont PAS lus par le site Tibiscui.fr :
-- cette copie n'a pas besoin de rester synchronisee avec dashboard-shared.js.
-- Le namespace SX est celui de l'addon qui charge le fichier (ici Opacity).
